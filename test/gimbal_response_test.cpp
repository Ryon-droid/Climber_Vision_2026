...
const std::string keys =
  ...
  "{circle      c  |         0.2         | delta_angle的切片数}"  //参数调整
...
int main(int argc, char * argv[])
{
  ...
  double error = 0;
  int count = 0;
  int step_dir = 1;          // step模式方向：1为正向，-1为反向
  const double step_limit = 40.0;  // step模式限位（度）
